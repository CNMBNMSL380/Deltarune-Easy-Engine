...
function Shop_SetMenuBuy(){
	...
	if(MENU = 0){
		...
		_right_dialog = "{choice_switch_direction 1}{choice_switch_sound false}{instant true}{define `PRICE` `"+string(Shop_GetBuyPrice(shop._page_buy*4+shop._buy_choice))+"`}{font 1}{space_y 4}{scale 2}{speed "+Lang_GetString("dialog.speed")+"}{shadow false}{gui false}{depth "+string(DEPTH_SHOP.DIALOG)+"}"+Lang_GetString("shop.menu.buy.confirm");
