...
live;
show_debug_message("--------------")
//Dr_Battle_FriendAnimMode(_char_id,DR_PLAYER_INDEX.IDLE,true,-1);
Dr_Battle_SetSpriteMode(_char_spr,DR_PLAYER_INDEX.IDLE);
...
//},50)
//Dr_Battle_FriendAnimMode(_char_id,DR_PLAYER_INDEX.INTRO,true,-1)
