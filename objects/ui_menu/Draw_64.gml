...
//draw_text_ext_transformed(32+6+8,52+(_top ? 270 : 0)+6+42-7,"LV  "+string(Flag_Get(FLAG_TYPE.STATIC,FLAG_STATIC.LV))+"\nHP  "+string(Flag_Get(FLAG_TYPE.STATIC,FLAG_STATIC.HP))+"/"+string(Flag_Get(FLAG_TYPE.STATIC,FLAG_STATIC.HP_MAX))+"\nG   "+string(Flag_Get(FLAG_TYPE.STATIC,FLAG_STATIC.GOLD)),9,-1,2,2,0);
draw_text_ext_transformed(32+6+8,52+(_top ? 270 : 0)+6+42,"LV  "+string(Flag_Get(FLAG_STATIC,"lv"))+"\nHP  "+string(Flag_Get(FLAG_STATIC,"hp"))+"/"+string(Flag_Get(FLAG_STATIC,"hp_max"))+"\nG   "+string(Flag_Get(FLAG_STATIC,"gold")),9,-1,2,2,0);
