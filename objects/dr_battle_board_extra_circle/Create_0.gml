...
function drawBorder(){
	draw_circle_color(x,y,radius+5,dr_battle_board.color_frame,dr_battle_board.color_frame,0);
	draw_circle_color(x,y,radius,dr_battle_board.color_bg,dr_battle_board.color_bg,0);
}