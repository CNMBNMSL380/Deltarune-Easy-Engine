...
_inst_frame_up=instance_create_depth(0,0,0,dr_battle_block);
_inst_frame_left=instance_create_depth(0,0,0,dr_battle_block);
_inst_frame_down=instance_create_depth(0,0,0,dr_battle_block);
_inst_frame_right=instance_create_depth(0,0,0,dr_battle_block);
