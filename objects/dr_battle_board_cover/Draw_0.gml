surface_set_target(dr_battle_board._surface1)
...
surface_set_target(dr_battle_board._surface)
af = dr_battle_board.alpha_frame/2+0.5
draw_sprite_ext(spr_pixel,0,_frame_up_x,_frame_up_y,_frame_up_width,_frame_up_height,_angle,dr_battle_board.color_frame,af);
draw_sprite_ext(spr_pixel,0,_frame_left_x,_frame_left_y,_frame_left_width,_frame_left_height,_angle,dr_battle_board.color_frame,af);
draw_sprite_ext(spr_pixel,0,_frame_down_x,_frame_down_y,_frame_down_width,_frame_down_height,_angle,dr_battle_board.color_frame,af);
draw_sprite_ext(spr_pixel,0,_frame_right_x,_frame_right_y,_frame_right_width,_frame_right_height,_angle,dr_battle_board.color_frame,af);
surface_reset_target();
