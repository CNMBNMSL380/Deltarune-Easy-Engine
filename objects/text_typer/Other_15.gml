...
_group_font[0,1]=Font_Get("FH12_2");
...
_group_font[1,1]=Font_Get("FH12_2");
...
_group_font_scale_x[3,0]=real(Lang_GetString("font.dialog.0.scale.x"));
_group_font_scale_y[3,0]=real(Lang_GetString("font.dialog.0.scale.y"));
_group_font_space_x[3,0]=real(Lang_GetString("font.dialog.0.space.x"));
_group_font[3,1]=font_sans;
_group_font_scale_x[3,1]=real(Lang_GetString("font.dialog.1.scale.x"));
_group_font_scale_y[3,1]=real(Lang_GetString("font.dialog.1.scale.y"));
_group_font_space_x[3,1]=real(Lang_GetString("font.dialog.1.space.x"));
_group_font_space_y[3]=real(Lang_GetString("font.dialog.space.y"));
...
_group_voice[4,0]=snd_text_voice_susie;
_group_voice[5,0]=noone;

_group_face[0]=face;
_group_face[1]=face_sans;
_group_face[2]=face_susie;